...
public class ProductServiceApplication implements CommandLineRunner {
	...
	private Tpc_MentorRepository mentorRepository1;
	...
	ProductServiceApplication(MentorRepository mentorRepository,
							  Tpc_MentorRepository mentorRepository1,
							  StudentRepository studentRepository,
							  UserRepository userRepository, St_UserRepository stUserRepository, St_StudentRepository stStudentRepository, St_MentorRepository stMentorRepository){
		this.mentorRepository = mentorRepository;
		this.mentorRepository1 = mentorRepository1;
        this.studentRepository = studentRepository;
        this.userRepository = userRepository;
        st_userRepository = stUserRepository;
        st_studentRepository = stStudentRepository;
        st_mentorRepository = stMentorRepository;
    }
...
//		System.out.println(user1);
		...
		com.productservice.productservice.inheritancerelations.singletable.User user = new com.productservice.productservice.inheritancerelations.singletable.User();
		user.setName("Amit");
